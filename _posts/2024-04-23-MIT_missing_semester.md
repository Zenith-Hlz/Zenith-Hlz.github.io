...
- [1. Course overview + the shell]({{ site.url }}/blogs/mit_missing_semester/1. Course overview + the shell)
- [2. Shell Tools and Scripting]({{ site.url }}/blogs/mit_missing_semester/2. Shell Tools and Scripting)
- [3. Editors(Vim)]({{ site.url }}/blogs/mit_missing_semester/3. Editors (Vim))
- [4. Data Wrangling]({{ site.url }}/blogs/mit_missing_semester/4. Data Wrangling)
- [5. Command-line Environment]({{ site.url }}/blogs/mit_missing_semester/5. Command-line Environment)
- [6. Version Control (Git)]({{ site.url }}/blogs/mit_missing_semester/6. Version Control (Git))
- [7. Debugging and Profiling]({{ site.url }}/blogs/mit_missing_semester/7. Debugging and Profiling)
- [8. Metaprogramming]({{ site.url }}/blogs/mit_missing_semester/8. Metaprogramming)
- [9. Security and Cryptography]({{ site.url }}/blogs/mit_missing_semester/9. Security and Cryptography)
- [10. Potpourri]({{ site.url }}/blogs/mit_missing_semester/10. Potpourri)
