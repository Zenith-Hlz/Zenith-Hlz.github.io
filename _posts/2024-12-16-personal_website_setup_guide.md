...
![fork]({{ site.url }}/assets/images/personal_website_setup_guide/fork.png)
...
Now, you may have noticed that on my site, clicking [This is my reference book]({{ site.url }}/files/CSAPP.pdf) takes you directly to CSAPP.
...
```markdown
[This is my file]({{ site.url }}/files/CSAPP.pdf)
...
- **Step 1:** Configure custom domain for GitHub Pages
  ...
  - Enter your domain name in the input field, for example `houlinzhi.com`, and a verification page will appear:
    ...
    ![verify]({{ site.url }}/assets/images/personal_website_setup_guide/verify.png)
