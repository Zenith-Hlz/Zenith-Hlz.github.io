---
layout: post
permalink: /blogs/document_reconstruction/index.html
title: 计算思维的应用 —— 粉碎后文件的复原问题
description: This article explores the challenge of reconstructing shredded or fragmented documents, inspired by real-world cases like the 1995 Stasi files reconstruction project in Germany. It discusses the historical background, the current state of document reconstruction, and the potential of computational thinking to improve the efficiency of document restoration.
categories: [blogs]
---
